...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/VaultLaboratories/metaplex-swift-program-library", branch: "main"),
        .package(url: "https://github.com/VaultLaboratories/Solana.Swift", branch: "master")
    ],
    targets: [
